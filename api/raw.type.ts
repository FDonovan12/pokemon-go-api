...
export interface AdvancedSettingData {
    ...
    maxDeviceMemoryForHighQualityModeMb:     number;
    maxDeviceMemoryForStandardQualityModeMb: number;
}

export interface WelcomeBackRewardsSettings {
    templateId: string;
    data:       WelcomeBackRewardsSettingData;
}
...
export interface CarouselDisplaySettings {
    questIconCarousels: QuestIconCarousel[];
}

export interface QuestIconCarousel {
    questTemplateId: string;
    rewardData:      RewardDatum[];
}
...
export interface RewardDatumItem {
    item:    string;
    amount?: number;
}
...
export interface ArPhotoFeatureFlagData {
    ...
    errorReportingSettings:    ErrorReportingSettingsClass;
    preLoginMetricsEnabled:    number;
    downloadMessageEnabled:    boolean;
    shareMessageEnabled:       boolean;
    signInButtonEnabled:       boolean;
    reorderSummary:            boolean;
}
...
export interface ErrorReportingSettingsClass {
    isEnabled:                    boolean;
...
export interface BreadEncounterVisualData {
    scale:           number;
...
export enum BreadMode {
    ...
    BreadSpecialMode = "BREAD_SPECIAL_MODE",
}

export interface BreadStationVisualData {
    scale:    number;
    xOffset?: number;
}
...
export interface InputBufferPriorityList {
    ...
    bufferBlockingEventTypeList: string[];
    inputBlockExceptionList?:    InputBlockExceptionList[];
}

export interface InputBlockExceptionList {
    currentAction:          string;
    allowedBufferedActions: string[];
}
...
export interface ErrorReportingSettings {
    templateId: string;
    data:       ErrorReportingSettingsClass;
}
...
export interface EventMapRefreshSettings {
    templateId: string;
    data:       EventMapRefreshSettingData;
}

export interface EventMapRefreshSettingData {
    eventServerSettingsHash: string;
}
...
export interface BreadOverride {
    ...
    maxStationVisualSettings?:         MaxBattleVisualSettings;
...
export interface ItemCurrencyValues {
    templateId: string;
    data:       ItemCurrencyValueData;
}

export interface ItemCurrencyValueData {
    itemCoinValues: ItemCoinValue[];
}

export interface ItemCoinValue {
    item:      string;
    coinValue: number;
}
...
export interface NaturalArtDayNightFeatureSettings {
    templateId: string;
    data:       NaturalArtDayNightFeatureSettingData;
}

export interface NaturalArtDayNightFeatureSettingData {
    dayStartTime:         string;
    dayEndTime:           string;
    nightEndTime:         string;
...
export interface QuestDialogueInboxSettings {
    templateId: string;
    data:       QuestDialogueInboxSettingData;
}

export interface QuestDialogueInboxSettingData {
    cooldownDurationMs:    string;
    QuestDialogueTriggers: QuestDialogueTrigger[];
}

export interface QuestDialogueTrigger {
    trigger:              string;
...
export interface RaidSettingData {
    ...
    fetchProfileFromSocialEnabled:         boolean;
    raidLevelEncounterTimings:             RaidLevelEncounterTiming[];
}
...
export interface RaidLevelEncounterTiming {
    showCatchLootOnPokemonPage:     boolean;
    autoThrowCountdownStartSeconds: number;
    autoThrowSeconds:               number;
}
...
export interface RaidEntryCostSettings {
    templateId: string;
    data:       RaidEntryCostSettingData;
}

export interface RaidEntryCostSettingData {
    raidLevelEntryCost: RaidLevelEntryCost[];
}

export interface RaidLevelEntryCost {
    raidLevel:     string;
    raidEntryCost: RaidEntryCost[];
}

export interface RaidEntryCost {
    raidType:        RaidType;
    itemRequirement: ExclusiveKeyItem;
}

export enum RaidType {
    RaidLocationRequerimentInPerson = "RAID_LOCATION_REQUERIMENT_IN_PERSON",
    RaidLocationRequerimentRemote = "RAID_LOCATION_REQUERIMENT_REMOTE",
}
...
export interface SharedFusionSettingData {
    ...
    fusionAlignmentSettings: FusionAlignmentSettings;
}

export interface FusionAlignmentSettings {
    disableShadowPokemonAsComponent:   boolean;
    disablePurifiedPokemonAsComponent: boolean;
}
...
export interface SoftSfidaSettingData {
    ...
    reservedGeofenceCount: number;
    geofenceSizeM:         number;
}
...
export interface SpecialResearchVisualRefreshSettings {
    templateId: string;
    data:       SpecialResearchVisualRefreshSettingData;
}

export interface SpecialResearchVisualRefreshSettingData {
    newQuestIndicatorsEnabled:            boolean;
    specialResearchCategoriesEnabled:     boolean;
    specialResearchCategoryColorsEnabled: boolean;
    updatedSortingEnabled:                boolean;
    multipleFavoritesEnabled:             boolean;
    tagNewQuestFromLapsedState:           boolean;
}
...
export interface CombatAnimationConfiguration {
    ...
    uiCameraAnimationSettings:               UiCameraAnimationSettings;
    missedFastAttackRecoverySettings:        MissedFastAttackRecoverySettings;
}

export interface MissedFastAttackRecoverySettings {
    enabled:           boolean;
    maxCatchUpAttacks: number;
}

export interface UiCameraAnimationSettings {
    transitionInDurationSeconds:   number;
    transitionInterimDelaySeconds: number;
    transitionOutDurationSeconds:  number;
}
...
export interface VnextBattleConfigData {
    ...
    pvpBattleConfig:   PvpBattleConfig;
}
...
export interface PvpBattleConfig {
    ...
    deadNetworkDisconnectThresholdTurns:          string;
    noOpponentConnectionDisconnectThresholdTurns: string;
    submitTurnNumberWithPlayerAction:             boolean;
    preResponseInputBlockDurationMs:              string;
}
